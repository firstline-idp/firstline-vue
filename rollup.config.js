...
const EXPORT_NAME = 'vueFirstline';
...
const footer = `('FirstlineClient' in this) && this.console && this.console.warn && this.console.warn('FirstlineClient already declared on the global namespace');
this && this.${EXPORT_NAME} && (this.FirstlineClient = this.FirstlineClient || this.${EXPORT_NAME}.FirstlineClient);`;
...
let bundles = [
  {
    ...
    output: {
      name: EXPORT_NAME,
      file: 'dist/firstline-vue.development.js',
      footer,
      format: 'umd',
      sourcemap: true,
      exports: 'default',
...
bundles = bundles.concat(
  {
    ...
    output: [
      {
        name: EXPORT_NAME,
        file: 'dist/firstline-vue.production.js',
        footer,
        format: 'umd',
        exports: 'default',
        globals: {
